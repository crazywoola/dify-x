...
- `agent-plugin-governance/`: Enterprise Agent plugin governance deck (CN/EN) covering tiered supply-chain controls, legal and marketplace trust design, and collaboration patterns derived from Dify 1.15 / 1.16.
...
- `agent-plugin-governance/index.html`: enterprise Agent plugin governance — six governance lenses, L1/L2/L3 controls, a one-year rollout, and the next Human × Agent × Workflow operating model.
